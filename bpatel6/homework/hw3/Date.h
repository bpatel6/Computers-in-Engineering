...
public:
    ...
    //////////////////////
    // Input: int - year, month and day
    // Description: Calculate age respect to 2/15/2019
    // Output: int age, which is the calculated age based on given input
    /////////////////////
    int getAge(int year=0, int month=0, int day=0) const;
