...
void simulatedPassByRef (int *ptr) {
	//Complete the implementation of this function to set the value of the int to 7
	*ptr = 7;
}
...
void miniassignment () {
    int x = 3;
    int y = 8;
    //Declare variable ptr as a pointer to int
    int *ptr;
    //Declare variable ptr2ptr as a pointer to pointer to int
    int **ptr2ptr;
    //Make ptr reference x
    ptr = &x;
    //Make ptr2ptr reference ptr
    ptr2ptr = &ptr;
    //Print the value of x using variable ptr
    cout << "x = " << *ptr << endl;
    //Print the value of x using variable ptr2ptr
    cout << "x = " << **ptr2ptr << endl;
    //Call the function simulatedPassByRef to change the value of x using ptr
    simulatedPassByRef(ptr);
    //Call the function simulatedPassByRef to change the value of y
    simulatedPassByRef(&y);
